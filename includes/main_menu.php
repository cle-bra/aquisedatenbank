  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link <?= $active(['index.php','dashboard.php']) ?>" href="/dashboard.php">Dashboard</a></li>
        <li class="nav-item"><a class="nav-link <?= $active(['companies.php','company_edit.php']) ?>" href="/companies.php">Firmen</a></li>
        <li class="nav-item"><a class="nav-link <?= $active(['contacts.php','contact_edit.php']) ?>" href="/contacts.php">Kontakte</a></li>
        <li class="nav-item"><a class="nav-link <?= $active(['dashboard.php']) ?>" href="/dashboard.php#campaigns">Kampagnen</a></li>
        <li class="nav-item"><a class="nav-link <?= $active(['contact_import.php']) ?>" href="/contact_import.php">Import (CSV)</a></li>
      </ul>
